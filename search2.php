...
var markers = {
    "Loc1": {"lat": 37.765136, "lng": -122.419112, "visible": true},
    "Loc2": {"lat": 37.800000, "lng": -122.419112, "visible": true}
};
...
function toggleMarkers(controlDiv, map){
    ...
    google.maps.event.addDomListener(controlUI, 'click', function(){
         for(var marker in markers){
             posMarkers[marker].setVisible(!posMarkers[marker].getVisible());
            }
    });
}
...
<BR>&nbsp;<BR>
    ...
    <div class="centre" id="searchContainer"><form action="./search1.php" method="GET"><input id="field" name="query" type="text" /> <!-- <div id="delete"><span id="x">x</span></div>--></form><br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <a href="./search1.php" method="GET" class="button white"><input id="field" name="query" type="text" />Submit</a> 
