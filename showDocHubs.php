...
<p></p>
		 <?php
						...
						$ctr=0;
							...
							echo " The following is a collection of the documentary hubs";
							echo '</br>';
			
							$query="SELECT * FROM dochubs" ;
...
<form action="showDocHubs.php" method="get">
...
<form action="showDocHubs1.php" method="get">
