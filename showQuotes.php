...
<p><br />&nbsp;<br /> <br />&nbsp;</p>
<p></p>
<div id="searchContainer"><form action="./showQuotes1.php" method="GET"><input id="field" name="query" type="text" /></form><br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> 
 <?php
        if($_GET["query"])
        {
            $var = $_GET["query"]; 
            ...
            mysql_select_db("internship");
                ...
                $query = "SELECT * FROM documentaries WHERE title LIKE '%".$var."%' ;";
