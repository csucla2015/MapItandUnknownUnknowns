...
<script src="js/bootstrap.min.js" type="text/javascript"></script>
        ...
        <form action="./showTVDB1.php" method="GET">       
...
<font color='white'>
 <?php
        if($_GET["query"])
        {
            ...
            mysql_select_db("internship");
                ...
                $query = "SELECT * FROM tvdb WHERE episode LIKE '%".$var."%' ;";
           ...
           echo '</br>';
            ...
            {$var4 = "Amazon Link";
        $var5="http://www.amazon.com/gp/prime";
                            $var2=$row[3];
 ...
 echo "Series : ".$row[2];
  echo '</br>';
 echo "Episode :";
 echo '<a href="' . $row[4] . '"><font color="white">'.$row[3].' </a>'; 
  echo '</br>';  


echo '<a href="' . $var5 . '"><font color="white">'.$var4.' </a>'; 
echo '</br>'; 
  ...
  echo '</br>';    echo '</br>';                  
            ...
            /*
            $query = "SELECT * FROM tvdb WHERE channel LIKE '%".$var."%' ;";
