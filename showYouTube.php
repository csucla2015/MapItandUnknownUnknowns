...
<p><br />&nbsp;<br /> <br />&nbsp;</p>
<p></p>
<div id="searchContainer"><form action="./showYouTube1.php" method="GET"><input id="field" name="query" type="text" /></form><br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> <br />&nbsp;<br /> 
 <?php
        if($_GET["query"])
        {
            $var = $_GET["query"]; 
            ...
            mysql_select_db("internship");
                ...
                $query = "SELECT * FROM youtubeplaylist WHERE user LIKE '%".$var."%' ;";
            ...
            while ($row = mysql_fetch_array($rs)) 
            {
                            $var2 = $row[2]." ".$row[1];
 echo '</br>';
                            echo '<a href="http://unknown-unknowns.com/showYoutubeInfo.php?id=' . $row[0] . '"><font color="white">'.$row[1].' </a>';
